...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.way.proto.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.way.proto.test.StringReq,
      com.way.proto.test.StringResp> getHelloMethodMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "HelloMethod",
      requestType = com.way.proto.test.StringReq.class,
      responseType = com.way.proto.test.StringResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.way.proto.test.StringReq,
      com.way.proto.test.StringResp> getHelloMethodMethod() {
    io.grpc.MethodDescriptor<com.way.proto.test.StringReq, com.way.proto.test.StringResp> getHelloMethodMethod;
      ...
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethodMethod = HelloServiceGrpc.getHelloMethodMethod) == null) {
          HelloServiceGrpc.getHelloMethodMethod = getHelloMethodMethod =
              io.grpc.MethodDescriptor.<com.way.proto.test.StringReq, com.way.proto.test.StringResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "HelloMethod"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.way.proto.test.StringReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.way.proto.test.StringResp.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void helloMethod(com.way.proto.test.StringReq request,
        io.grpc.stub.StreamObserver<com.way.proto.test.StringResp> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.way.proto.test.StringReq,
                com.way.proto.test.StringResp>(
                  this, METHODID_HELLO_METHOD)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.way.proto.test.StringResp helloMethod(com.way.proto.test.StringReq request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.way.proto.test.StringResp> helloMethod(
        com.way.proto.test.StringReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO_METHOD:
          serviceImpl.helloMethod((com.way.proto.test.StringReq) request,
              (io.grpc.stub.StreamObserver<com.way.proto.test.StringResp>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.way.proto.test.HelloProto.getDescriptor();
    }
